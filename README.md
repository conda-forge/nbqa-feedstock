...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nbqa-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10977&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nbqa-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nbqa` can be installed with:

```
conda install nbqa
```

It is possible to list all of the versions of `nbqa` available on your platform with:
